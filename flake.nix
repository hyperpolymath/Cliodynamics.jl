{
  description = "Cliodynamics.jl - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 Cliodynamics.jl development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P Cliodynamics.jl.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/Cliodynamics.jl $out/bin/  # Rust
            # cp bin/Cliodynamics.jl $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/Cliodynamics.jl";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-Cliodynamics.jl" {
