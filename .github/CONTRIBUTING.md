...
git clone <https://github.com/hyperpolymath/Cliodynamics.jl.git> cd
Cliodynamics.jl
...
toolbox create Cliodynamics.jl-dev toolbox enter Cliodynamics.jl-dev \#
...
Cliodynamics.jl/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/Cliodynamics.jl/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/Cliodynamics.jl/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/Cliodynamics.jl/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/Cliodynamics.jl/labels/perimeter-3) — Community sandbox scope
