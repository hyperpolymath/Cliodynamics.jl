...
doctor:
    @echo "Running diagnostics for Cliodynamics.jl..."
...
help-me:
    @echo "=== Cliodynamics.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/Cliodynamics.jl/issues/new"
    @echo ""
