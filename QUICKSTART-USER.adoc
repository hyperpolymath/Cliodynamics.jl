= Cliodynamics.Jl — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/Cliodynamics.jl
cd Cliodynamics.jl
...
* https://github.com/hyperpolymath/Cliodynamics.jl/issues — report bugs
