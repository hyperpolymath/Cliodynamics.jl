...
= Contributing — Cliodynamics.jl
:toc: left

Contributions to `Cliodynamics.jl` follow the Hyperpolymath estate conventions:
...
[source,bash]
----
git clone git@github.com:hyperpolymath/Cliodynamics.jl.git
cd Cliodynamics.jl
